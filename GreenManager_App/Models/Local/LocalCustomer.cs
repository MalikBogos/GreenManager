...
{
	/// <summary>
	/// Platte, lokale representatie van een klant (Customer) die wordt opgeslagen in de SQLite-databank op het toestel. Navigatie-eigenschappen ontbreken opzettelijk om Joins te vermijden.
	/// </summary>
